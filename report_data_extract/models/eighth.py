...
class ChangInShareholdAndRemuner(CommonInfo):
    ...
    age = models.IntegerField(verbose_name='年龄',default=0,blank=True,null=True)
    ...
    share_held_num_begin = models.IntegerField(verbose_name='期初持股数',default=0,blank=True,null=True)
    share_held_num_end = models.IntegerField(verbose_name='期末持股数',default=0,blank=True,null=True)
    increas_or_decreas_num = models.IntegerField(verbose_name='股份增减变动量',default=0,blank=True,null=True)
